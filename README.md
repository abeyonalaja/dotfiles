    ...
    sh -c "`curl -fsSL https://raw.github.com/abeyonalaja/dotfiles/master/install.sh`"
...
about each one, use:
```bash
sh -c "`curl -fsSL https://raw.github.com/abeyonalaja/dotfiles/master/install.sh`" -s ask
```
